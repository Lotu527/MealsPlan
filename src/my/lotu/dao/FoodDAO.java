...
public class FoodDAO extends BasicDao{
	...
	public Food findById(java.lang.Integer id) {
		...
		try {
			Food instance = (Food) getSession().get("my.lotu.dao.Food", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Food instance) {
		...
		try {
			List results = getSession().createCriteria("my.lotu.dao.Food")
	...
	public List findByCarbohydrate(Object carbohydrate) {
		return findByProperty(CARBOHYDRATE, carbohydrate);
	}
